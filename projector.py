...
def draw_camera_background(surface, frame):
    """Рисует кадр с камеры как фон на всю поверхность.
...
def draw_ui(surface, font, is_running, ball_detected, fps):
    ...
    for line in lines:
        ...
        surface.blit(shadow, (surface.get_width() - text.get_width() - 9, y_offset + 1))
